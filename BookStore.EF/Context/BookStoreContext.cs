...
namespace BookStore.EF.Context
{
    public class BookStoreContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //    j =>
            //    {
            //        j.HasKey(st => new { st.DepartmentId, st.BookId });
            //        j.ToTable("Stores");
            //    });
           ...
           .UsingEntity<StoreEntity>(
              ...
              j => j
               ...
               j =>
               {
                   j.HasKey(t => new { t.DepartmentId, t.BookId });
                   j.ToTable("Stores");
               });
            ...
            var listStores = new List<StoreEntity>()
            {
                new StoreEntity(){ }
            };
